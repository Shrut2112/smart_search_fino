...
def init_worker():
    ...
    if embeddings is None:
        ...
        if embeddings is None:
            log.error("CRITICAL: Failed to initialize Cohere embedding model!")
            raise RuntimeError("Cohere embedding model failed to initialize. Check COHERE_API_KEY.")

        log.info("Cohere embedding model initialized for parser agent")
